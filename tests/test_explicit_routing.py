...
from ostruct.cli.explicit_file_processor import ExplicitFileProcessor, ExplicitRouting, ProcessingResult
...
class TestExplicitFileProcessor:
    ...
    async def test_process_file_routing_basic(self):
        ...
        self.processor._validate_routing_security = AsyncMock(return_value=ExplicitRouting(
...
class TestFileRoutingPerformance:
    ...
    def test_large_file_list_processing(self):
        ...
        large_file_list = [(f"template", f"/test/file_{i}.py") for i in range(100)]
    ...
    def test_mixed_tool_performance(self):
        ...
        # Verify distribution
        total_files = (len(routing.template_files) + 
