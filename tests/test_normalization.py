...
from ostruct.cli.security import PathSecurityError, SecurityErrorReasons, normalize_path
...
def test_normalize_path_unsafe_unicode():
    ...
    assert exc_info.value.context["reason"] == SecurityErrorReasons.UNSAFE_UNICODE
...
def test_normalize_path_directory_traversal():
    ...
    assert exc_info.value.context["reason"] == SecurityErrorReasons.PATH_TRAVERSAL
