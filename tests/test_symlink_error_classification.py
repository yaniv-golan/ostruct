...
def verify_error_type(path: Path, expected_error: str, fs: FakeFilesystem):
    ...
    assert exc_info.value.context["reason"] == expected_error, (
        f"Expected {expected_error}, got {exc_info.value.context['reason']}"
    )


def test_direct_loop(fs: FakeFilesystem):
...
def test_broken_symlink(fs: FakeFilesystem):
    """Test classification of truly broken symlinks."""
    # Create a symlink to nonexistent file
    fs.create_symlink("/test_workspace/base/broken.txt", "/test_workspace/base/nonexistent.txt")
...
def test_chain_to_loop(fs: FakeFilesystem):
    ...
    fs.create_symlink("/test_workspace/base/loop.txt", "/test_workspace/base/loop.txt")
    # Create a chain leading to it
    fs.create_symlink("/test_workspace/base/chain1.txt", "/test_workspace/base/loop.txt")
    fs.create_symlink("/test_workspace/base/chain2.txt", "/test_workspace/base/chain1.txt")
...
def test_chain_to_broken(fs: FakeFilesystem):
    ...
    fs.create_symlink("/test_workspace/base/link1.txt", "/test_workspace/base/nonexistent.txt")
    fs.create_symlink("/test_workspace/base/link2.txt", "/test_workspace/base/link1.txt")
...
def test_loop_with_valid_branch(fs: FakeFilesystem):
    ...
    fs.create_symlink("/test_workspace/base/valid.txt", "/test_workspace/base/real.txt")
...
def test_complex_loop(fs: FakeFilesystem):
    ...
    fs.create_symlink("/test_workspace/base/link1.txt", "/test_workspace/base/link2.txt")
    fs.create_symlink("/test_workspace/base/link2.txt", "/test_workspace/base/link3.txt")
    fs.create_symlink("/test_workspace/base/link3.txt", "/test_workspace/base/link4.txt")
    fs.create_symlink("/test_workspace/base/link4.txt", "/test_workspace/base/link2.txt")
...
def test_nested_valid_symlinks(fs: FakeFilesystem):
    ...
    fs.create_file("/test_workspace/base/real.txt", contents="real")
    fs.create_symlink("/test_workspace/base/link1.txt", "/test_workspace/base/real.txt")
    fs.create_symlink("/test_workspace/base/link2.txt", "/test_workspace/base/link1.txt")
    fs.create_symlink("/test_workspace/base/link3.txt", "/test_workspace/base/link2.txt")
...
def test_loop_precedence_over_broken(fs: FakeFilesystem):
    ...
    fs.create_symlink("/test_workspace/base/link1.txt", "/test_workspace/base/link2.txt")
    fs.create_symlink("/test_workspace/base/link2.txt", "/test_workspace/base/link1.txt")
    fs.create_symlink("/test_workspace/base/link2_to_nowhere.txt", "/test_workspace/base/nonexistent.txt")
