...
class TemplateOptimizer:
    ...
    def _extract_file_path(self, content_expr: str) -> Optional[str]:
        ...
        if match:
            ...
            if any(keyword in var_name.lower() for keyword in ['file', 'config', 'data', 'script', 'code']):
    ...
    def _should_stay_inline(self, file_path: str) -> bool:
        ...
        try:
            ...
            if path.exists() and path.is_file():
                ...
                if content_size <= self.inline_threshold and '\n' not in content.strip():
                    return True
    ...
    def _build_complete_appendix(self) -> str:
        ...
        """
        appendix_lines = ["=" * 50, "APPENDIX: Referenced Files and Directories", "=" * 50]
...
def is_optimization_beneficial(template_content: str, threshold_chars: int = 1000) -> bool:
